			...
			<Zoom {...zoomInProperties}>
				{images.map((each, index) => (
					<div key={index} className="flex justify-center md:items-center items-start w-screen h-screen relative">
                        ...
                        <h1 className="absolute mb-20 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">Bet-Karoo</h1>
                        ...
                        <p className="absolute  md:top-120 top-120 text-white mb-100 text-base !leading-relaxed text-body-color sm:text-lg md:text-4xl">India's Most Trusted Betting Id Provider</p>
                        <Link
                        href="https://github.com/NextJSTemplates/startup-nextjs"
                        className="absolute  top-204  mb-150 inline-block rounded-sm bg-black  text-white  px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-black/90 dark:bg-white/10 dark:text-white dark:hover:bg-white/5"
